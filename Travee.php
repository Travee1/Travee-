<?php
/*
تنشر اذكر الصدر @T_T_UY
*/
ob_start();
$API_KEY = '7247081800:AAHpVRAwOwblflhDJcp5ywgOrHpqctVCryU;
...
$alwsh = "@TG_TUU";
$sudo = "7524071373";
$Dev = array("7524071373","",""); //ID ADMIN NUMBER 1 HE CHAT
//****************//
@$usernamebot = "TG_TUU"; //UserName Bot
@$channel = "T_T_UY"; // UserName Channel don't @
@$token = API_KEY;
...
$from_id = $message->from->id;
$join = file_get_contents("https://api.telegram.org/bot".API_KEY."/getChatMember?chat_id=@T_T_UY&user_id=".$from_id);
...
",
 'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"آلـمـطـور ™",'url'=>"t.me/TG_TUU"]],
]])
]);
}}
